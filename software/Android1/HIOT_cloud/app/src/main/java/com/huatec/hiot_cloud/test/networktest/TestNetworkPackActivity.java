...
public class TestNetworkPackActivity extends BaseActivity implements com.huatec.hiot_cloud.test.networktest.TestNetworkPackView {
    ...
    @Override
    public TestNetworkPresenter createPresenter() {
