...
public class TestRetrofitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUserInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getUserInfo("58d2e00d4def465d901394b67094dee4_f16ed8a8f9c546d9aca18edfc4113914_use");
        ...
        btnUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updateEmail("58d2e00d4def465d901394b67094dee4_f16ed8a8f9c546d9aca18edfc4113914_use",
                        "ouypi@qq.com");
            }
        });
    ...
    private void register() {
        ...
        userBean.setUsername("oyyping");
        userBean.setEmail("oyyping@qq.com");
